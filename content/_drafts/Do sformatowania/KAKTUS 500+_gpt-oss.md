...
```mermaid
flowchart TD
    A[Zamrożenie owoców] --> B[Mieszanie pierwszej warstwy]
    B --> C[Wstawienie pojemnika z pomarańczem]
    C --> D[Zamrażanie 60 min]
    D --> E[Mieszanie truskawek z wodą i erytrytolem]
    E --> F[Wylanie truskawkowej warstwy]
    F --> G[Zamrażanie 60 min]
    G --> H[Przygotowanie zielonej polewy]
    H --> I[Wylanie polewy na górę]
    I --> J[Ostatnie zamrażanie 60 min]
    J --> K[Gotowe lody kaktus]
```

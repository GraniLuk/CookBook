...
```mermaid
graph TD
    A[Zbierz składniki] --> B[Ser alafeta 200 g do kielicha]
    B --> C[Dodaj 50 ml oleju z ziołami]
    C --> D[Pulsuj blenderem kilka razy]
    D --> E[Dodaj twaróg i świeżo mielony pieprz]
    E --> F[Blenduj do gładkości]
    F --> G[Przelej do słoika]
    G --> H[Wypełnij do 500 ml]
    H --> I[Chłódź w lodówce]
```

...
```mermaid
flowchart TD
    A[Zbierz składniki] --> B{Blenduj w blenderze}
    B --> C[Podgrzej patelnię]
    C --> D{Smaruj olejem}
    D --> E[Wlej ciasto]
    E --> F[Gotuj na średnim ogniu]
    F --> G{Przewróć, gdy brzegi podniosą się}
    G --> H[Powtarzaj od E]
    H --> I[Gotowe 16 pancake'ów]
    I --> J[Podawaj z dodatkami]
```

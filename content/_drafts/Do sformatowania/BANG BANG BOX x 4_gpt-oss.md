...
```mermaid
flowchart TD
    A[Rozpoczęcie] --> B[Pokrojenie kurczaka]
    B --> C[Marynowanie]
    C --> D[Gotowanie ryżu]
    D --> E[Parzenie brokułów]
    E --> F[Przygotowanie sosu Bang Light]
    F --> G[Smażenie kurczaka w air fryerze]
    G --> H[Łączenie w misce]
    H --> I[Podanie z sezamem i zieloną cebulką]
    I --> J[Gotowe]
```

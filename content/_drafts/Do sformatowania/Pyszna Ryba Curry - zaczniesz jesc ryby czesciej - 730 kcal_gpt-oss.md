---
title: Pyszna Ryba Curry - zaczniesz jesc ryby czesciej - 730 kcal_gpt-oss
...
```mermaid
flowchart TD
    A[Rozgrzewamy patelnię] --> B[Dorzucamy szalotkę]
    B --> C[Smażymy szalotkę]
    C --> D[Dodajemy kmin]
    D --> E[Smażymy 1 minutę]
    E --> F[Wkładamy pastę kary]
    F --> G[Smażymy <1 min]
    G --> H[Doprowadzenie do gotowania]
    H --> I[Dodajemy pomidory]
    I --> J[Gotujemy sos]
    J --> K[Dodajemy dorsza]
    K --> L[Gotowe]
```

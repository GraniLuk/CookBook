...
```mermaid
flowchart TD
    A[Rozgrzanie patelni] --> B[Rozgrzanie mięsa]
    B --> C[Dodanie oregano]
    C --> D[Odstawienie mięsa]
    D --> E[Dodanie serka wiejskiego]
    E --> F[Ugotowanie jajecznicy]
    F --> G[Przygotowanie warzyw]
    G --> H[Rozłożenie wrapów]
    H --> I[Wypełnienie każdego wrapa]
    I --> J[Zawijanie wrapów]
    J --> K[Zamrażanie]
    K --> L[Podgrzewanie i podanie]
```

...
```mermaid
sequenceDiagram
    participant A as Patelnia (Strona 1)
    participant B as Duży Talerz
    A->>B: Przykrycie talerzem
    B->>A: Odwrócenie patelni (Placek spada na talerz)
    A->>A: Zrzucenie placka na patelnię (Strona 2)
```

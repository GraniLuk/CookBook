...
```mermaid
flowchart TD
    A[Start: Gotowanie po wakacjach] --> B[Przygotowanie składników]
    B --> C[Pokrojony boczek i czosnek]
    C --> D[Rozgrzanie garnka, smażenie boczku]
    D --> E[Dodanie czosnku]
    E --> F[Dodanie kurczaka 200 plus]
    F --> G[Gotowanie makaronu 200 g]
    G --> H[Przygotowanie mieszanki jajek i 50 g parmezanu]
    H --> I[Łączenie makaronu, kurczaka, boczku, czosnku i mieszanki jajecznej]
    I --> J[Dodanie soli i pieprzu, gauki]
    J --> K[Podanie 2 porcji karbonary]
    K --> L[Ok, gotowe!]
```

...
```mermaid
flowchart TD
    A[Rozmrażanie krewetek] --> B[Obieranie krewetek]
    B --> C[Dzielimy na 4 części]
    C --> D[Gotowanie cebuli i czosnku]
    D --> E[Dodaj oliwę]
    E --> F[Smażenie cebuli i czosnku]
    F --> G[Gotowanie makaronu]
    G --> H[Dodaj pomidory Polpa]
    H --> I[Mieszanie z wodą z makaronu]
    I --> J[Dodaj krewetki]
    J --> K[Gotowanie 2‑3 min]
    K --> L[Dodaj masło]
    L --> M[Mieszanie i doprawianie]
    M --> N[Wsyp natkę pietruszki]
    N --> O[Pakowanie do boxów]
    O --> P[Gotowe]
```

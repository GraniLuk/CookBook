...
```mermaid
flowchart TD
  A[Mięso i cebula] --> B[Czosnek i przyprawy]
  B --> C[Smażenie mięsa]
  C --> D[Passata, woda, koncentrat]
  D --> E[Sos gotowy]
  A --> F[Twaróg]
  F --> G[Sól, pieprz, muszkatoł]
  G --> H[Mleko]
  H --> I[Beszamel gotowy]
  A --> J[Dynia, cukinia]
  J --> K[Warstwy: makaron, sos, warzywa, beszamel, szynka]
  K --> L[Pieczenie]
  L --> M[Gotowe do podania]
```

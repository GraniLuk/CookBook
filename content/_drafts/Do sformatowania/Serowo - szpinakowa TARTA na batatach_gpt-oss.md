...
```mermaid
flowchart TD
    A[Przygotuj bataty] --> B[Pokrój w talarki 2‑3 mm]
    B --> C[Obtocz w oliwie z tymiankiem i rozmarynem]
    C --> D[Rozłóż w formie, piecz 10‑15 min]
    D --> E[Obierz cebulę, tłucz czosnek]
    E --> F[Smaż cebulę + czosnek na 20 ml oliwy]
    F --> G[Dodaj szpinak, dopraw pieprzem i muszkatołową]
    G --> H[Zdejmij z ognia, ostygnij]
    H --> I[Wymieszaj twaróg, jajka, feta, szpinak]
    I --> J[Wyłóż farsz na bataty]
    J --> K[Posyp feta i suszone pomidorki]
    K --> L[Piecz 25 min przy 200 °C]
    L --> M[Gotowe – podawaj i smakuj!]
```

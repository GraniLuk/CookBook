...
created: 2025-10-27
description: Szczegółowy przepis na przygotowanie trzech pełnowartościowych, wysokobiałkowych i niskotłuszczowych zestawów obiadowych (lunch boxów) z pieczonym kurczakiem, batatami, brokułami i cebulą, zorganizowany w prosty proces pieczenia.
category: Fitness
length: 1086
tags:
  - Summaries/Przepisy
...
```mermaid
timeline
    title Harmonogram Pieczenia (Piekarnik 200°C)
    section Faza Wstępna
        0 min : Warzywa do piekarnika (Dół)
    section Faza Główna
        10 min : Kurczak do piekarnika
        40 min : Wyjęcie Warzyw
    section Faza Końcowa
        40 min : Kurczak zostaje + Włączenie Termo obiegu
        45 min : Wyjęcie Kurczaka
```

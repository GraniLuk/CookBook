---
title: Pyszna LASAGNE Bolognese z miesem bez beszamelu. Po studencku - szybko i konkretnie!_gemini
...
sequenceDiagram
    ...
    participant L as Lasagne
    P->>L: Włóż do piekarnika
    Note right of L: Pieczemy 10 minut z przykrywką (gotowanie i roztapianie sera)
    L->>P: Zdejmij przykrywkę
    Note right of L: Pieczemy 5 minut bez przykrywki (przyrumienienie i przypieczenie)
    P->>L: Wyłącz piekarnik
    L->>P: Wyciągnij
```

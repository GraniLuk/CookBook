...
```mermaid
flowchart TD
    A[Moczenie daktyli] --> B[Blendowanie]
    B --> C[Mieszanie z płatkami]
    C --> D[Formowanie w pojemnikach]
    D --> E[Owijanie papierem]
    E --> F[Chłodzenie w lodówce]
    F --> G[Przygotowanie galaretki]
    G --> H[Łączenie galaretki z batonami]
    H --> I[Wycinanie i podawanie]
```

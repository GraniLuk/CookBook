---
title: Letni OBIAD x3 - Kurczak w PIWNO - MIODOWYM sosie + warzywa_gpt-oss
...
```mermaid
flowchart TD
    A[Rozpocznij] --> B[Przygotuj ziemniaki]
    B --> C[Piecz ziemniaki 180°C 15‑18 min]
    C --> D[Przygotuj szparagi]
    D --> E[Zawij szparagi w szynkę]
    E --> F[Piecz szparagi]
    F --> G[Przygotuj kurczaka]
    G --> H[Dodaj czosnek, cebulę, miód, sos sojowy, oliwę, cytrynę]
    H --> I[Piecz kurczaka 180°C]
    I --> J[Redukuj sos piwny‑miodowy]
    J --> K[Dodaj kurczaka do sosu]
    K --> L[Montaż lunchboxów]
    L --> M[Gotowe do pakowania]
    M --> N[Smacznego]
```
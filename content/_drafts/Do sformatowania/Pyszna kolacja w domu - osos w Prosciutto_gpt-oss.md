...
```mermaid
flowchart TD
    A[Przygotuj warzywa] --> B[Gotuj ziemniaki i kalafior]
    B --> C[Przygotuj łososia]
    C --> D[Pieczenie łososia w szynce]
    D --> E[Zrób sos pistacjowy]
    E --> F[Zrób puree ziemniaczano‑kalafiorowe]
    F --> G[Układanie na talerz]
    G --> H[Podanie z sałatką]
    H --> I[Zdjęcie i udostępnienie]
```
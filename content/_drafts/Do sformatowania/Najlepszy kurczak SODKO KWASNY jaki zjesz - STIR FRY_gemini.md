...
sequenceDiagram
    ...
    participant W as Wok (Wysoka Temperatura)
    P -> W: Olej (15-20 ml)
    W -> W: Wstępna obróbka kurczaka (80-90% gotowości)
    W -> P: Kurczak zdjęty (zachowanie soczystości)
    P -> W: Kolejna porcja oleju
    P -> W: Aromaty (Imbir/Czosnek)
    W -> W: Eksplozja aromatów
    P -> W: Warzywa (Brokuł, Marchewka)
    W -> W: Szybka obróbka warzyw
    P -> W: Kurczak wraca
    W -> W: Smażenie całości (stirowanie)
    P -> W: Sos Słodko-Kwaśny
    W -> W: Zagęszczenie (aktywacja skrobi)
    W -> P: Gotowe danie na talerz
```

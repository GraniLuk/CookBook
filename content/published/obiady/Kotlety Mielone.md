...
fodmap:
  ...
  notes: Cebula w małych ilościach na porcję.
  substitutions: []
---

## Składniki
*   800 g mięsa mielonego (wieprzowe + odrobina wołowego)
*   2 średnie cebule
*   2 jajka
*   1 bułka pszenna
*   Bułka tarta (ok. 50 g)
*   Sól
*   Pieprz
*   Olej do smażenia (ok. 50 g)

## Sposób przygotowania
1.  Namoczyć bułkę w ciepłej wodzie.
2.  Do miski wrzucić mięso wraz z wyciśniętą wcześniej bułką i dokładnie wymieszać.
3.  Posiekać drobno cebulę i wrzucić do miski, następnie dodać jedno całe jajko i jedno żółtko.
4.  Doprawić solą i pieprzem i dokładnie wymieszać.
5.  Białko, które zostało roztrzepać w oddzielnej miseczce.
6.  Przygotować bułkę tartą w oddzielnej miseczce.
7.  Formować delikatnie kotlety, następnie posmarować je białkiem i obsypać bułką.
8.  Smażyć na głębokim oleju. Zmniejszyć ogień po chwili smażenia.

## Podsumowanie wartości odżywczych (całe danie)

| Składnik           | Ilość (g) | Kalorie (kcal) | Białko (g) | Tłuszcze (g) | Węglowodany (g) |
|--------------------|-----------|----------------|------------|--------------|-----------------|
| Mięso mielone      | 800       | 1600           | 128.0      | 96.0         | 0.0             |
| Cebula             | 200       | 80             | 2.0        | 0.0          | 18.0            |
| Jajka              | 140       | 155            | 12.6       | 10.6         | 1.1             |
| Bułka pszenna      | 50        | 150            | 5.0        | 1.0          | 30.0            |
| Bułka tarta        | 50        | 180            | 6.0        | 1.0          | 35.0            |

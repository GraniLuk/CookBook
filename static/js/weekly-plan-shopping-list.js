(function () {
  ...
  const categoryMap = new Map(
    Object.entries({
      ...
      "seler korzeń": "Warzywa i owoce",
      szparagi: "Warzywa i owoce",
      szczypiorek: "Warzywa i owoce",
      truskawki: "Warzywa i owoce",
      ziemniaki: "Warzywa i owoce",
      cukinia: "Warzywa i owoce",
      "kapusta czerwona": "Warzywa i owoce",
      pietruszka: "Warzywa i owoce",
      por: "Warzywa i owoce",

      boczek: "Mięso i ryby",
      "boczek wędzony": "Mięso i ryby",
      "kości cielęce": "Mięso i ryby",
      ...
      "ser grana padano": "Nabiał i jajka",
      "ser żółty": "Nabiał i jajka",
      "skyr naturalny": "Nabiał i jajka",
      "śmietana 18%": "Nabiał i jajka",
      "śmietanka kremówka 30%": "Nabiał i jajka",
      "śmietanka 30%": "Nabiał i jajka",
      twaróg: "Nabiał i jajka",
      "twaróg chudy": "Nabiał i jajka",

      chleb: "Zboża i pieczywo",
      "domowa granola": "Zboża i pieczywo",
      granola: "Zboża i pieczywo",
      bułka: "Zboża i pieczywo",
      "bułka tarta": "Zboża i pieczywo",
      "bułka pita": "Zboża i pieczywo",
      "tortilla lub bułka pita": "Zboża i pieczywo",
      ...
      "olej lniany": "Tłuszcze i sosy",
      "olej roślinny": "Tłuszcze i sosy",
      "olej sezamowy": "Tłuszcze i sosy",
      "oliwa z oliwek": "Tłuszcze i sosy",
      ...
      "przyprawa uniwersalna do mięs": "Przyprawy i dodatki",
      "przyprawa korzenna": "Przyprawy i dodatki",
      rozmaryn: "Przyprawy i dodatki",
      sezam: "Przyprawy i dodatki",
      "liść laurowy": "Przyprawy i dodatki",
      "ziele angielskie": "Przyprawy i dodatki",
      "pieprz ziarnisty": "Przyprawy i dodatki",
      "papryka słodka": "Przyprawy i dodatki",
      "garam masala": "Przyprawy i dodatki",
    })
  );
